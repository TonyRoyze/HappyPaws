...
public class CaretakerReviewRecViewAdaptor extends RecyclerView.Adapter<CaretakerReviewRecViewAdaptor.ViewHolder> {
    List<Review> reviews = new ArrayList<>();
    List<User> users = new ArrayList<>();
    DatabaseHelper databaseHelper;
    Context context;

    public CaretakerReviewRecViewAdaptor(Context context) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        Review review;
        CaretakerReviewRecViewAdaptor adapter;
        ...
        public ViewHolder linkAdapter(CaretakerReviewRecViewAdaptor adapter) {
